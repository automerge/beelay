...
use crate::{
    effects::TaskEffects,
    parse,
    sedimentree::{self, MinimalTreeHash, Sedimentree},
...
impl ReachabilityIndex {
    ...
    pub(crate) async fn from_tree<R: rand::Rng>(
    ...
    pub(crate) async fn load<R: rand::Rng>(effects: TaskEffects<R>, doc_id: &DocumentId) -> Self {
        ...
        .await
        .unwrap_or_default();
        Self::from_tree(effects, tree).await
    }

    pub(crate) fn has_link(&self, to: &DocumentId) -> bool {
